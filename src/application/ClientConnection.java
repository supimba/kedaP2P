...
public class ClientConnection implements Runnable {
				...
				switch(actionChoice){
					case "registration":
						...
						try{
							...
							logger.info("Client registration with socket address " + connectedClientIP + " impossible");
						}
	...
	private void registerClient(Client client){		
		...
		// end of registration
		logger.info("Registration from " + client.getClientIp() + " with client UUID ["+client.getUuid() +"] complete");
